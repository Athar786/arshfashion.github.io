...
Contributors: Micro Ocean Technologies
Tags: MoceanSMS, WooCommerce, Order notification, SMS notification, SMS, notification, order
...
Try for FREE. 20 trial SMS credits will be given upon registration (https://dev.moceansms.com/register?fr=wp). Additional SMS credits can be requested and is subject to approval by MoceanSMS.
...
Search for "MoceanSMS Order SMS Notification for WooCommerce" in "Add Plugin" page and activate it.
